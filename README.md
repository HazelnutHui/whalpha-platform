...
- Private static deployment package: the workstation can export private Dashboard JSON snapshots, build a `/dashboard/` React bundle, and produce a versioned OCI bundle for a future authenticated static deployment.
