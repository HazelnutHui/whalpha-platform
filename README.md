...
- Initial persistence: mocked-fixture one-session EOD Price Bar V1 Parquet writer with manifest, deterministic fingerprint, idempotency, and conflict checks; real 2026-08-13 EOD publication remains blocked by quality gates.
