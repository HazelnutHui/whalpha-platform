...
- Private static deployment: the workstation exports private Dashboard JSON snapshots, builds a `/dashboard/` React bundle, and deploys a versioned OCI release protected by Basic Auth for the personal prototype.
