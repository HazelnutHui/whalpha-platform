...
- First EOD development provider: Massive Stocks Basic for private, personal EOD development only; mocked adapter skeleton implemented, no real credentials or network transport yet.
