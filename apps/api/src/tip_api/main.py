...
from tip_api.persistence.parquet.dashboard_universe_activation import CompletedDashboardUniverseActivation, DashboardUniverseActivationError, read_completed_dashboard_universe_activation
    ...
    *,
    ...
    if cfg.enable_private_market_data_routes:
        ...
        if activation is None:
            ...
            if sessions:
                try:
                    activation=read_completed_dashboard_universe_activation(cfg.market_data_root,analysis_session=sessions[-1].session_date,validate_sources=True)
