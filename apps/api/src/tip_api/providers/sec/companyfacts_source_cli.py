"""CLI for bounded SEC Company Facts bulk-source acquisition."""
...
def main(argv: list[str] | None = None) -> int:
            ...
            json.dumps(
                {
                    ...
                    "record_type": "sec_companyfacts_chunk_checkpoint",
    ...
    try:
        ...
        result = acquire_sec_companyfacts_source_package(
            config=config,
    ...
    except (SecCompanyfactsSourceError, SecCredentialFileError, OSError, RuntimeError, ValueError) as exc:
        print(
            json.dumps(
                {
                    "status": "stopped",
    ...
    print(
        json.dumps(
            {
                "contract_version": CONTRACT_VERSION,
                "record_type": "sec_companyfacts_source_completion",
                ...
                "member_payload_validation_status": manifest.member_payload_validation_status,
                "credential_material_retained": False,
                "canonical_data_write_count": 0,
                "publication_count": 0,
                "deployment_count": 0,
