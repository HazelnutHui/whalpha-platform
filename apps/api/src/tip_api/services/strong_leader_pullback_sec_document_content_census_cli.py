"""CLI for the Strong-Leader Pullback SEC document content census."""
...
from tip_api.services.strong_leader_pullback_sec_document_content_census import (
    StrongLeaderPullbackSecDocumentContentCensusError,
    build_strong_leader_pullback_sec_document_content_census,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = build_strong_leader_pullback_sec_document_content_census(
            plan_root=args.plan,
