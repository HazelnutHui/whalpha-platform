"""CLI for bounded Strong-Leader Pullback SEC Form 25 candidates."""
...
from tip_api.services.strong_leader_pullback_sec_form25_candidates import (
    StrongLeaderPullbackSecForm25CandidatesError,
    build_strong_leader_pullback_sec_form25_candidates,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = build_strong_leader_pullback_sec_form25_candidates(
            plan_root=args.plan,
        ...
        json.dumps(
            {
                ...
                "form25_document_count": report.form25_document_count,
                "instrument_count": report.instrument_count,
                "duplicate_instrument_count": report.duplicate_instrument_count,
                ...
                "complete_field_support_counts": report.complete_field_support_counts,
...
def _clean_revision() -> str:
    ...
    if status:
        raise StrongLeaderPullbackSecForm25CandidatesError("repository must be clean")
