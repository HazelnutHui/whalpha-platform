"""CLI for first-strategy SEC source-party relation evidence."""
...
from tip_api.services.strong_leader_pullback_sec_party_relation_adjudication import (
    StrongLeaderPullbackSecPartyRelationAdjudicationError,
    build_strong_leader_pullback_sec_party_relation_adjudication,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = build_strong_leader_pullback_sec_party_relation_adjudication(
            plan_root=args.plan,
        ...
        json.dumps(
            {
                ...
                "matched_relation_count": report.matched_relation_count,
                "ambiguous_relation_count": report.ambiguous_relation_count,
                "unsupported_relation_count": report.unsupported_relation_count,
                "relation_topology_counts": report.relation_topology_counts,
                "listed_equity_consideration_case_count": (
                    report.listed_equity_consideration_case_count
                ),
                "report_sha256": result.report_sha256,
                "logical_fingerprint": report.logical_fingerprint,
                "network_request_count": 0,
                "counterparty_stable_id_assignment_count": 0,
                "successor_stable_id_assignment_count": 0,
                "consideration_issuer_stable_id_assignment_count": 0,
                "lifecycle_fact_count": 0,
