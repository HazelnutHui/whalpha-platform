"""CLI for first-strategy SEC listing-termination reason evidence."""
...
from tip_api.services.strong_leader_pullback_sec_termination_reason_adjudication import (
    StrongLeaderPullbackSecTerminationReasonAdjudicationError,
    build_strong_leader_pullback_sec_termination_reason_adjudication,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = build_strong_leader_pullback_sec_termination_reason_adjudication(
            plan_root=args.plan,
            ...
            transaction_event_custody_root=(
                args.transaction_events_custody_root
            ),
        ...
        json.dumps(
            {
                ...
                "matched_reason_count": report.matched_reason_count,
                "ambiguous_reason_count": report.ambiguous_reason_count,
                "unsupported_reason_count": report.unsupported_reason_count,
                "listing_action_counts": report.listing_action_counts,
                "report_sha256": result.report_sha256,
                "logical_fingerprint": report.logical_fingerprint,
                "network_request_count": 0,
                "effective_delisting_date_count": 0,
                "first_or_last_tradable_date_count": 0,
                "lifecycle_fact_count": 0,
