"""CLI for the outcome-blind Strong-Leader Pullback terminal-gap census."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = service.build_strong_leader_pullback_terminal_gap_census(
        ...
        json.dumps(
            {
                ...
                "remaining_gap_instrument_count": (
                    report.remaining_gap_instrument_count
                ),
...
def _clean_revision() -> str:
    ...
    if status:
        raise service.StrongLeaderPullbackTerminalGapCensusError(
