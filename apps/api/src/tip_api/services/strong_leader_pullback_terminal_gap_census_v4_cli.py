"""CLI for the local-evidence terminal-gap census extension."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    for name in (
        ...
        "termination-reasons",
        "termination-reasons-custody-root",
        "submissions-package",
    ...
    try:
        result = service.build_strong_leader_pullback_terminal_gap_census_v4(
        ...
        json.dumps(
            {
                ...
                "extension_reference_count": report.extension_reference_count,
...
def _clean_revision() -> str:
    ...
    if status:
        raise service.StrongLeaderPullbackTerminalGapCensusV4Error(
