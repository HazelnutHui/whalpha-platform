"""CLI for first-strategy terminal-payoff source terms."""
...
from tip_api.services.strong_leader_pullback_terminal_payoff_terms import (
    StrongLeaderPullbackTerminalPayoffTermsError,
    build_strong_leader_pullback_terminal_payoff_terms,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = build_strong_leader_pullback_terminal_payoff_terms(
        ...
        json.dumps(
            {
                ...
                "source_numeric_term_count": report.source_numeric_term_count,
                "fixed_cash_payoff_term_count": report.fixed_cash_payoff_term_count,
                "listed_equity_ratio_case_count": (
                    report.listed_equity_ratio_case_count
                ),
                "cvr_case_count": report.cvr_case_count,
                "holder_election_case_count": report.holder_election_case_count,
                "fixed_cash_and_timing_ready_count": (
                    report.fixed_cash_and_timing_ready_count
                ),
