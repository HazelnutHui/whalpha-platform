"""CLI for the two-document terminal-reference SEC supplement plan."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        publish = (
            service
            .publish_strong_leader_pullback_terminal_reference_sec_supplement_plan
        )
        result = publish(
        ...
        json.dumps(
            {
                ...
                "ticker_locators": [
                    item.ticker_locator for item in report.items
                ],
...
def _clean_revision() -> str:
    ...
    if status:
        raise service.TerminalReferenceSecSupplementPlanError(
