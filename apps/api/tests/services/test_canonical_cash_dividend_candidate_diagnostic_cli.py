...
from tip_api.services import canonical_cash_dividend_candidate_diagnostic_cli as cli
...
def test_cli_emits_bounded_flags(monkeypatch, capsys) -> None:
    ...
    exit_code = cli.main(
        [
            ...
            "/data/trading-intelligence-platform/source/manifest.json",
            "--eod-evidence-path",
    ...
    assert payload["review_flags"] == [{"index": 0}, {"index": 1}]
