...
def test_capability_reserves_executes_and_records_exactly_one_plan() -> None:
    ...
    def reserve(**kwargs):
        ...
        return MarketIntelligenceApplyCustodyResult(
            outcome="reserved",
            attempt_id="b" * 64,
            event=_event("market_intelligence_apply_started"),
    ...
    def record(**kwargs):
        ...
        return MarketIntelligenceApplyCustodyResult(
            outcome="succeeded",
            attempt_id="b" * 64,
            event=_event("market_intelligence_apply_succeeded"),
            approval_plan=approval,
            active_publication=SimpleNamespace(),
            reason_code="market_intelligence_active_state_formally_proven",
        )

    capability = DailyEodMarketIntelligenceApplyCapability(
    ...
    assert evidence.publication_id == "publication-1"
