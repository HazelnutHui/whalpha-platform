...
function assessment(channel: string) {
  return {
    ...
    parameter_fingerprint: SHA, as_of_session: '2026-08-26', universe_id: 'primary',
    instrument_id: ID, ticker: 'TEST', security_type: 'CS', channel,
    status: 'advance_to_research', channel_score: '82.0000', within_channel_rank: 1,
    ...
    evidence: [{ evidence_id: 'component_stock_relative_strength', evidence_kind: 'supporting', role: 'primary',
...
function payload() {
  return {
    ...
    source: {
      ...
      strategy_parameter_fingerprint: SHA, strategy_oracle_mismatch_count: 0,
