...
const COPY = {
  en: {
    ...
    agentPilot: 'Stage-isolated research team', agentPilotNote: 'The first manually supervised multi-Agent pilot has qualified its outcome-blind market-state input with an exact replay. Specialized roles may now design a finite Campaign Three protocol; outcomes remain closed.', agentPilotBadge: 'INPUT QUALIFIED · PROTOCOL DESIGN',
    agentStats: ['Market-state qualification', 'Exact replay', 'Campaign Three', 'Validation / Holdout'], agentStatValues: ['PASSED · 267 / 287', 'MATCHED', 'NOT REGISTERED', 'SEALED'],
    agentStages: [
      ...
      ['03', 'Protocol and ledger design', 'CURRENT', 'Define a finite hypothesis set, trial budget, multiplicity rule, nulls, and stop rule before opening any outcome.'],
    ...
    screeningV2Next: 'Next governed question', screeningV2NextValue: 'NEW FACTOR BATCH · NOT YET REGISTERED', screeningV2NextBody: 'The next design will test whether point-in-time market structure changes factor applicability. Market state, interactions, horizons, sample floors, and trial budgets must be frozen before Development outcomes reopen.',
  ...
  zh: {
    ...
    agentPilot: '阶段隔离的研究协作组', agentPilotNote: '第一次人工监督的多 Agent 试点已通过结果盲市场状态输入资格审查，并完成精确重放。专业角色现在可以设计有限的第三批协议，但结果读取仍保持关闭。', agentPilotBadge: '输入已准入 · 协议设计',
    agentStats: ['市场状态资格', '精确重放', '第三批研究', 'Validation / Holdout'], agentStatValues: ['通过 · 267 / 287', '完全一致', '尚未登记', '保持密封'],
    agentStages: [
      ['01', '独立审查', '已完成', '治理、方法和实现审查在真实运行前发现并修正了实质问题。'],
      ['02', '市场状态资格审查', '已完成', '287个交易日全部完成；重建宽度联合可用267日，独立规范字节重放完全一致。'],
      ['03', '设计协议与账本', '当前', '在读取任何结果前，冻结有限假设、试验预算、多重检验、零假设和停止规则。'],
    ...
    screeningV2Next: '下一项受控问题', screeningV2NextValue: '新因子批次 · 尚未登记', screeningV2NextBody: '下一步将检验点时市场结构是否改变因子的适用性。市场状态、交互、周期、样本下限和试验预算必须先冻结，之后才能再次打开开发期结果。',
  ...
  es: {
    ...
    agentPilot: 'Equipo de investigación aislado por etapas', agentPilotNote: 'El primer piloto multiagente supervisado ya calificó el estado de mercado sin consultar resultados y completó una reproducción exacta. Ahora puede diseñar un protocolo finito para la Campaña Tres; los resultados siguen cerrados.', agentPilotBadge: 'ENTRADA CALIFICADA · DISEÑO',
    agentStats: ['Calificación de mercado', 'Reproducción exacta', 'Campaña Tres', 'Validación / Holdout'], agentStatValues: ['SUPERADA · 267 / 287', 'COINCIDE', 'NO REGISTRADA', 'SELLADOS'],
    agentStages: [
      ...
      ['03', 'Diseño de protocolo y registro', 'ACTUAL', 'Definir hipótesis finitas, presupuesto, multiplicidad, nulos y regla de parada antes de abrir cualquier resultado.'],
    ...
    screeningV2Next: 'Siguiente pregunta gobernada', screeningV2NextValue: 'NUEVO LOTE DE FACTORES · AÚN NO REGISTRADO', screeningV2NextBody: 'El próximo diseño probará si la estructura de mercado point-in-time modifica la aplicabilidad de los factores. Estados, interacciones, horizontes, mínimos muestrales y presupuesto deben congelarse antes de reabrir resultados.',
