(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'DISCOVERY CATALOG', currentProgram: 'Factor Discovery V1', researchState: '12 definitions registered · outcome-blind qualification next',
      ledgerData: 'Factor definitions', ledgerModel: 'Outcome-blind coverage', ledgerValidation: 'Model construction', ledgerAuthority: 'Candidate authority',
      stateBuilding: '12 registered', stateLocked: 'Not yet measured', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'No return is read before the screening protocol is frozen.', notClaim: 'NO FACTOR ALPHA OR MODEL YET', priorProgram: 'The first Pullback program is retained as a reproducible rejection; it was not retuned or promoted.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '因子发现目录', currentProgram: '因子发现 V1', researchState: '12项定义已登记 · 下一步为不读取结果的资格诊断',
      ledgerData: '因子定义', ledgerModel: '不含结果的覆盖诊断', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '已登记12项', stateLocked: '尚未测量', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '因子筛选协议冻结前，不读取任何未来收益。', notClaim: '尚无因子 Alpha 或模型', priorProgram: '首个强势股回撤项目已作为可复现的拒绝结果留档，没有重新调参或进入产品。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CATÁLOGO DE DESCUBRIMIENTO', currentProgram: 'Descubrimiento de factores V1', researchState: '12 definiciones registradas · siguiente paso: calificación sin resultados',
      ledgerData: 'Definiciones de factores', ledgerModel: 'Cobertura sin resultados', ledgerValidation: 'Construcción del modelo', ledgerAuthority: 'Autoridad sobre Candidatos',
      stateBuilding: '12 registradas', stateLocked: 'Aún no medida', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'No se consulta ninguna rentabilidad antes de congelar el protocolo de selección.', notClaim: 'AÚN NO HAY ALPHA DE FACTORES NI MODELO', priorProgram: 'El primer programa de retroceso queda archivado como rechazo reproducible; no se reajustó ni se promovió.',
