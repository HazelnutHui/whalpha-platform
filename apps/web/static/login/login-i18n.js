(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'CURRENT FACTOR CAMPAIGN', currentProgram: 'Campaign Three', researchState: 'Registered · outcomes unread',
      ...
      stateBuilding: '17 total · 3 unread', stateQualified: 'Complete', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'The first two campaigns closed without candidate Alpha. Campaign Three has three registered trials and no result yet. No model or strategy exists.', notClaim: 'NO ALPHA, MODEL, OR STRATEGY ADMITTED', priorProgram: 'Only research produced inside the factor → model → strategy architecture is presented as current Product research. Earlier pre-architecture methods remain internal audit history.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '当前因子研究批次', currentProgram: '第三批研究', researchState: '已登记 · 结果尚未读取',
      ledgerData: '累计试验账本', ledgerModel: '冻结协议', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '共17项 · 3项未读结果', stateQualified: '已完成', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '前两批研究均在没有候选 Alpha 的状态下关闭；第三批已登记3项试验，但尚无结果。目前没有模型或策略。', notClaim: '尚无获准的 ALPHA、模型或策略', priorProgram: '只有按“因子发现 → 模型构建 → 策略表达”产生的研究才作为当前产品研究展示；三层体系建立前的方法只保留在内部审计历史中。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CAMPAÑA ACTUAL DE FACTORES', currentProgram: 'Tercera campaña', researchState: 'Registrada · resultados sin consultar',
      ...
      stateBuilding: '17 en total · 3 sin resultado', stateQualified: 'Completo', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'Las dos primeras campañas se cerraron sin Alpha candidato. La tercera tiene tres pruebas registradas y aún no tiene resultados. No existe ningún modelo ni estrategia.', notClaim: 'NINGÚN ALPHA, MODELO NI ESTRATEGIA ADMITIDOS', priorProgram: 'Solo la investigación producida dentro de la arquitectura factor → modelo → estrategia se presenta como investigación actual del producto. Los métodos anteriores quedan solo en el historial interno de auditoría.',
