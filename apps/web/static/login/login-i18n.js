(() => {
  ...
  const messages = {
    en: {
      ...
      heroEyebrow: 'Systematic multi-market equity research', heroTitle: 'Quantitative research that stands up to scrutiny.',
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'CURRENT FACTOR CAMPAIGN', currentProgram: 'Campaign Three', researchState: 'Closed · no candidate Alpha',
      ledgerData: 'Cumulative trial ledger', ledgerModel: 'Frozen protocol', ledgerValidation: 'Model construction', ledgerAuthority: 'Candidate authority',
      stateBuilding: '17 total · all closed', stateQualified: 'Complete', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'All three campaigns closed without candidate Alpha. The third campaign\'s formal run and exact replay matched; no model or strategy exists.', notClaim: 'NO ALPHA, MODEL, OR STRATEGY ADMITTED', priorProgram: 'Only research produced inside the factor → model → strategy architecture is presented as current Product research. Earlier pre-architecture methods remain internal audit history.',
      ...
      marketFoundation: 'MARKET FOUNDATION', ashareKicker: 'China A-share research track', ashareTitle: 'Five years of evidence—still behind a formal admission gate.',
      ashareText: 'The independent SSE/SZSE pilot now reconciles its official calendar, effective-dated trading rules, price limits, statutory fees, and account-cost assumptions. Corporate actions, lifecycle, daily Universe, and the complete 13-family admission remain open.',
      ashareScope: '1,211 sessions', ashareMechanics: '7,266 mechanics decisions', ashareResearch: '0 factor campaigns', ashareBoundary: 'No A-share backtest, Alpha, model, ranking, or strategy is active. U.S. and China market data and authority remain isolated.',
      ...
      footerText: 'Transparent quantitative research across separately governed markets.',
    },
    zh: {
      title: 'WH Alpha 量化研究',
      ...
      heroEyebrow: '系统化多市场股票量化研究', heroTitle: '让每一个量化模型，都经得起追问。',
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '当前因子研究批次', currentProgram: '第三批研究', researchState: '已关闭 · 无候选 Alpha',
      ledgerData: '累计试验账本', ledgerModel: '冻结协议', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '共17项 · 全部关闭', stateQualified: '已完成', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '三批研究均在没有候选 Alpha 的状态下关闭；第三批正式运行与精确重放一致，目前没有模型或策略。', notClaim: '尚无获准的 ALPHA、模型或策略', priorProgram: '只有按“因子发现 → 模型构建 → 策略表达”产生的研究才作为当前产品研究展示；三层体系建立前的方法只保留在内部审计历史中。',
      ...
      marketFoundation: '市场数据基础', ashareKicker: '中国 A 股研究轨道', ashareTitle: '五年证据基础，仍须通过正式准入。',
      ashareText: '独立的沪深试点已经完成官方日历、按生效日期管理的交易规则、涨跌停、法定费用和账户成本假设核对；公司行动、生命周期、逐日 Universe 与完整 13 类数据准入仍未完成。',
      ashareScope: '1,211 个交易日', ashareMechanics: '7,266 条制度判定', ashareResearch: '0 个因子研究批次', ashareBoundary: '当前没有 A 股回测、Alpha、模型、排名或策略；美股与 A 股的数据和权限始终隔离。',
      ...
      footerText: '面向严格隔离市场的透明、可验证量化研究。',
    },
    es: {
      ...
      heroEyebrow: 'Investigación sistemática de renta variable en varios mercados', heroTitle: 'Investigación cuantitativa que resiste un examen riguroso.',
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CAMPAÑA ACTUAL DE FACTORES', currentProgram: 'Tercera campaña', researchState: 'Cerrada · sin Alpha candidato',
      ledgerData: 'Registro acumulativo', ledgerModel: 'Protocolo congelado', ledgerValidation: 'Construcción del modelo', ledgerAuthority: 'Autoridad sobre Candidatos',
      stateBuilding: '17 en total · todas cerradas', stateQualified: 'Completo', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'Las tres campañas se cerraron sin Alpha candidato. La ejecución formal y la reproducción exacta de la tercera coincidieron; no existe ningún modelo ni estrategia.', notClaim: 'NINGÚN ALPHA, MODELO NI ESTRATEGIA ADMITIDOS', priorProgram: 'Solo la investigación producida dentro de la arquitectura factor → modelo → estrategia se presenta como investigación actual del producto. Los métodos anteriores quedan solo en el historial interno de auditoría.',
      ...
      marketFoundation: 'BASE DE MERCADO', ashareKicker: 'Línea de acciones A de China', ashareTitle: 'Cinco años de evidencia, aún sujetos a admisión formal.',
      ashareText: 'El piloto independiente SSE/SZSE ya concilia calendario oficial, reglas temporales, límites de precio, tasas legales y supuestos de costes. Acciones corporativas, ciclo de vida, Universo diario y la admisión de 13 familias siguen pendientes.',
      ashareScope: '1.211 sesiones', ashareMechanics: '7.266 decisiones de reglas', ashareResearch: '0 campañas factoriales', ashareBoundary: 'No hay backtest, Alpha, modelo, ranking ni estrategia activa para acciones A. Los datos y la autoridad de EE. UU. y China permanecen aislados.',
      ...
      footerText: 'Investigación cuantitativa transparente en mercados gobernados por separado.',
    },
  };
