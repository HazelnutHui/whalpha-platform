(() => {
  ...
  const messages = {
    en: {
      ...
      capRotationTitle: 'Sector ETF Rotation', capRotationText: 'Compare fixed sector ETF proxies with SPY across independent 5, 10, and 20-session windows, acceleration, and leadership persistence.', capRotationPoint1: 'Leadership and deterioration without a composite score', capRotationPoint2: 'Themes stay unavailable until membership is governed',
    ...
    zh: {
      ...
      capRotationTitle: '行业ETF轮动', capRotationText: '使用固定行业ETF与SPY比较，分别观察5、10、20日相对表现、加速度和领先持续性。', capRotationPoint1: '不使用综合总分，直接展示领先与走弱', capRotationPoint2: '主题成分完成治理前保持不可用',
