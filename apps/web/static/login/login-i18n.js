(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'DISCOVERY CATALOG', currentProgram: 'Factor Discovery V2', researchState: 'Development screen closed · no candidate Alpha',
      ...
      stateBuilding: 'Screened · 8 definitions', stateQualified: 'Passed · 98.59% coverage', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'Six Development trials are complete and all 14 cumulative trials remain recorded. Four Alpha trials failed; two risk guards qualified but were not selected. Exact replay is verified.', notClaim: 'NO ALPHA FACTOR OR MODEL ADMITTED', priorProgram: 'Factor Catalogs V1 and V2 and the first Pullback program remain reproducible failed research—not predictive models.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '因子发现目录', currentProgram: '因子发现 V2', researchState: '开发期筛选已关闭 · 无候选 Alpha',
      ledgerData: 'V2 因子目录', ledgerModel: '数据资格诊断', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '已筛选 · 8项定义', stateQualified: '已通过 · 覆盖率98.59%', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '6项开发期试验已经完成，累计14项试验全部留档。4项 Alpha 失败；2项风险护栏通过但未入选；精确重放已经验证。', notClaim: '尚无获准的 Alpha 因子或模型', priorProgram: '因子目录 V1、V2 与首个强势股回撤项目均作为可复现的失败研究留档，不是预测模型。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CATÁLOGO DE DESCUBRIMIENTO', currentProgram: 'Descubrimiento de factores V2', researchState: 'Selección en Desarrollo cerrada · sin Alpha candidato',
      ...
      stateBuilding: 'Evaluado · 8 definiciones', stateQualified: 'Superada · cobertura del 98,59 %', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'Las seis pruebas de Desarrollo han finalizado y las 14 pruebas acumuladas siguen registradas. Fallaron cuatro pruebas Alpha; dos salvaguardas de riesgo superaron los criterios, pero no fueron seleccionadas. La reproducción exacta está verificada.', notClaim: 'NINGÚN FACTOR ALPHA NI MODELO ADMITIDO', priorProgram: 'Los Catálogos V1 y V2 y el primer programa Pullback se conservan como investigación fallida reproducible, no como modelos predictivos.',
