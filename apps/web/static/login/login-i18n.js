(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'DISCOVERY CATALOG', currentProgram: 'Factor Discovery V2', researchState: 'Data qualification blocked · 0 of 4 Alpha factors admitted',
      ...
      stateBuilding: 'Registered · 8 definitions', stateLocked: 'Rejected · 60.89% coverage', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'The report and full replay match exactly. No future return was read; the next action repairs split-evidence coverage without changing the protocol.', notClaim: 'NO ALPHA FACTOR OR MODEL ADMITTED', priorProgram: 'Factor Catalog V1 and the first Pullback program remain reproducible failures. V2 is blocked by source coverage—not presented as a predictive result.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '因子发现目录', currentProgram: '因子发现 V2', researchState: '数据资格诊断受阻 · 4项候选 Alpha 均未获准',
      ledgerData: 'V2 因子目录', ledgerModel: '数据资格诊断', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '已登记 · 8项定义', stateLocked: '未通过 · 覆盖率60.89%', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '正式报告与完整重放完全一致，且未读取任何未来收益；下一步只修复拆股证据覆盖，不修改协议。', notClaim: '尚无获准的 Alpha 因子或模型', priorProgram: '因子目录 V1 与首个强势股回撤项目继续作为可复现失败留档；V2 因来源覆盖受阻，不会被包装成预测结果。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CATÁLOGO DE DESCUBRIMIENTO', currentProgram: 'Descubrimiento de factores V2', researchState: 'Calificación de datos bloqueada · 0 de 4 factores Alpha admitidos',
      ...
      stateBuilding: 'Registrado · 8 definiciones', stateLocked: 'Rechazada · cobertura del 60,89 %', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'El informe y la reproducción completa coinciden exactamente. No se consultaron rendimientos futuros; el siguiente paso repara la cobertura de splits sin cambiar el protocolo.', notClaim: 'NINGÚN FACTOR ALPHA NI MODELO ADMITIDO', priorProgram: 'El Catálogo V1 y el primer programa Pullback se conservan como fallos reproducibles. V2 está bloqueado por cobertura de fuentes, no se presenta como resultado predictivo.',
