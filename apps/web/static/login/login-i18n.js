(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'DISCOVERY CATALOG', currentProgram: 'Factor Discovery V1', researchState: 'Development screen closed · no candidate Alpha',
      ledgerData: 'Factor qualification', ledgerModel: 'Development screen', ledgerValidation: 'Model construction', ledgerAuthority: 'Candidate authority',
      stateBuilding: 'Replayed', stateLocked: 'Closed · 0 Alpha / 1 risk', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'Outcomes were opened only after the finite protocol was frozen; the complete result replay matched exactly.', notClaim: 'NO ALPHA FACTOR OR MODEL ADMITTED', priorProgram: 'The first Pullback program and Factor Catalog V1 are retained as reproducible failures; neither was retuned or promoted.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '因子发现目录', currentProgram: '因子发现 V1', researchState: '开发期筛选已关闭 · 无候选 Alpha',
      ledgerData: '因子资格诊断', ledgerModel: '开发期筛选', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '已精确重放', stateLocked: '已关闭 · 0项Alpha / 1项风险', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '只在有限协议冻结后读取结果；完整结果的第二次计算精确一致。', notClaim: '尚无获准的 Alpha 因子或模型', priorProgram: '首个强势股回撤项目与因子目录 V1 均作为可复现的失败结果留档，没有重新调参或进入产品。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CATÁLOGO DE DESCUBRIMIENTO', currentProgram: 'Descubrimiento de factores V1', researchState: 'Selección de Desarrollo cerrada · sin candidato de Alpha',
      ledgerData: 'Calificación de factores', ledgerModel: 'Selección de Desarrollo', ledgerValidation: 'Construcción del modelo', ledgerAuthority: 'Autoridad sobre Candidatos',
      stateBuilding: 'Reproducida', stateLocked: 'Cerrada · 0 Alpha / 1 riesgo', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'Los resultados se consultaron solo después de congelar el protocolo finito; la reproducción completa coincidió exactamente.', notClaim: 'NINGÚN FACTOR ALPHA NI MODELO ADMITIDO', priorProgram: 'El primer programa Pullback y el Catálogo V1 se conservan como fallos reproducibles; ninguno se reajustó ni se promovió.',
