(() => {
  ...
  const messages = {
    en: {
      ...
      workspaceReady: 'Workspace ready', signIn: 'Account sign in', continue: 'Enter the research workspace with an existing account.', invalid: 'Invalid username or password.',
    ...
    zh: {
      ...
      workspaceReady: '工作区可用', signIn: '账号登录', continue: '使用已有账号进入研究工作区。', invalid: '用户名或密码错误。',
