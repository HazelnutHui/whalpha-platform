(() => {
  ...
  const messages = {
    en: {
      ...
      dossierAria: 'Current research record', dossierLabel: 'Current research record', modelFamily: 'DISCOVERY CATALOG', currentProgram: 'Factor Discovery V2', researchState: 'Data qualification passed · finite Development screen next',
      ...
      stateBuilding: 'Registered · 8 definitions', stateQualified: 'Passed · 98.59% coverage', statePending: 'Locked', stateInactive: 'Inactive', dossierFoot: 'Two byte-identical runs passed the frozen data gates without reading future returns. The next action registers a finite Development screen before outcomes are opened.', notClaim: 'NO ALPHA FACTOR OR MODEL ADMITTED', priorProgram: 'Factor Catalog V1 and the first Pullback program remain reproducible failures. V2 is qualified for screening-protocol review—not presented as a predictive result.',
    ...
    zh: {
      ...
      dossierAria: '当前研究档案', dossierLabel: '当前研究档案', modelFamily: '因子发现目录', currentProgram: '因子发现 V2', researchState: '数据资格诊断通过 · 下一步登记有限开发期筛选',
      ledgerData: 'V2 因子目录', ledgerModel: '数据资格诊断', ledgerValidation: '模型构建', ledgerAuthority: '候选排行权限',
      stateBuilding: '已登记 · 8项定义', stateQualified: '已通过 · 覆盖率98.59%', statePending: '保持锁定', stateInactive: '未激活', dossierFoot: '两次逐字节一致的运行在未读取未来收益的前提下通过冻结的数据门槛；下一步先登记有限开发期筛选，再开放结果。', notClaim: '尚无获准的 Alpha 因子或模型', priorProgram: '因子目录 V1 与首个强势股回撤项目继续作为可复现失败留档；V2 仅获准进入筛选协议审查，不会被包装成预测结果。',
    ...
    es: {
      ...
      dossierAria: 'Registro de investigación actual', dossierLabel: 'Registro de investigación actual', modelFamily: 'CATÁLOGO DE DESCUBRIMIENTO', currentProgram: 'Descubrimiento de factores V2', researchState: 'Calificación de datos superada · sigue una selección finita en Desarrollo',
      ...
      stateBuilding: 'Registrado · 8 definiciones', stateQualified: 'Superada · cobertura del 98,59 %', statePending: 'Bloqueada', stateInactive: 'Inactiva', dossierFoot: 'Dos ejecuciones idénticas byte a byte superaron los filtros de datos congelados sin consultar rendimientos futuros. El siguiente paso registra una selección finita en Desarrollo antes de abrir resultados.', notClaim: 'NINGÚN FACTOR ALPHA NI MODELO ADMITIDO', priorProgram: 'El Catálogo V1 y el primer programa Pullback se conservan como fallos reproducibles. V2 solo está habilitado para revisar el protocolo de selección; no se presenta como resultado predictivo.',
