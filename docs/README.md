...
- [Historical Identity Source Apply Plan V1](data-contracts/historical-identity-source-apply-plan-v1.md): combined candidate census and inventory-bound prospective copy plan with no Apply executor or authority.
