...
- [Daily EOD Automation Control Plane](operations/daily-eod-automation.md): Exact-session planning, single-action offline execution, durable Dell run custody, interruption recovery, and remaining unattended-operation gates.
