# Historical Execution Archive Through 2026-09-14

This file preserves the former granular project changelog, including detailed
run narratives, hashes, test counts, and superseded intermediate states. It is
historical evidence, not a current-state or next-action authority. Recover
current work from [current context](../project/current-context.md),
[current status](../project/current-status.md), and the
