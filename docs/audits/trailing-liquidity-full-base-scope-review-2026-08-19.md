...
The corrected four-source ledger also references the IPO Form 424B4 ([official SEC filing](https://www.sec.gov/Archives/edgar/data/1861737/000110465923017567/tm2120356-28_424b4.htm), document/filing date 2023-02-08) and 2023 Form 20-F ([official SEC filing](https://www.sec.gov/Archives/edgar/data/1861737/000110465924051452/hsai-20231231x20f.htm), reporting date 2023-12-31). Together they support an open-ended `ADR/ADS` security-form interval beginning with the Nasdaq ADS listing on 2023-02-09. Document/reporting dates, optional filing-acceptance dates, covered-fact effective dates, and 2026-08-21 review/record timestamps remain separate; the annual-report acceptance dates are left null because they were not supplied and were not fetched. The 2026-07-10 Form 6-K records only the 1:8 ADS ratio adjustment; the security form is ADRC on both sides and `adjustment_factors_unverified` remains active.

Two independent production-root dry-runs of immutable revision `authoritative-security-form-v2` produced byte-identical temporary Parquet files and fingerprints. Each yielded Primary 1,718 CS (fingerprint `c3665203965b96528c9be07db3c49d18023104e346da16050f1170d4fe148978`) and Secondary 1,831 = 1,718 CS + 113 ADRC (fingerprint `2dce08e728774510878c47dc80898e10236952dacd146990ad344c4dcb75a295`). HSAI fails Primary at `target_security_form` and passes every existing Secondary quantitative gate: supported exchange, current/previous bars, previous close 17.11, 20 observations, and median proxy `24932582.63967815500000000000`.

The planned superseding manifest uses schema 2.0 and immutable revision `authoritative-security-form-v2`. Each offline dry-run wrote and formally reread only a temporary target: one reviewed-form row with four source-ledger entries, 4,565 metrics, 9,130 complete decisions, 3,549 memberships, 3,549 diffs, and 20 funnels. Fraction-oracle mismatches and V1 reproduction mismatches were zero. No `--apply` ran; production remains 1,641/1,747, and the completed 1,719/1,831 shadow remains unchanged.
