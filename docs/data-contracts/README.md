...
- [China A-Share Full-Population Coverage Diagnostic V1](china-a-share-full-population-coverage-v1.md)
- [China A-Share Official-Evidence Priority Plan V1](china-a-share-official-evidence-priority-plan-v1.md)
- [China A-Share Local Official-Evidence Reuse and Warning Batch V1](china-a-share-local-official-evidence-reuse-and-warning-batch-v1.md)
- [China A-Share Warning Evidence Acquisition V1](china-a-share-warning-evidence-acquisition-v1.md)
- [China A-Share Warning Evidence Acquisition V2](china-a-share-warning-evidence-acquisition-v2.md)
...
- [Quant Research Discovery Trial Ledger V3](quant-research-discovery-trial-ledger-v3.md)
  closes all 14 consumed V1/V2 trials and records zero model inputs.
...
- [Quant Research Discovery Trial Ledger V5](quant-research-discovery-trial-ledger-v5.md)
  closes all 17 consumed trials after Campaign Three's exact formal/replay
  pair, with zero admitted Alpha and zero model inputs.
- [Quant Research Discovery Trial Ledger V4](quant-research-discovery-trial-ledger-v4.md)
  remains the immutable pre-outcome registration state for Campaign Three.
...
- [Quant Research Factor Screening V2](quant-research-factor-screening-v2.md)
  freezes the six-trial Development screen and its separated
  factor/control/label evidence boundary; its closed result is recorded in the
  [V2 screening audit](../audits/quant-research-factor-screening-v2-2026-09-15.md).
