...
After reviewing diagnostic schema `2.0`, separately authorize at most one bounded SEC evidence run to capture actionable candidate evidence; do not alter allowlists from assumptions. Core/Broad production activation remains deferred.
