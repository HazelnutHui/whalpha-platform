...
4. Advance ADR 0130's disconnected segmented Candidate shadow from exact V1
   ...
   one-session append/recovery/cold-equivalence proof to direct current-session
   segment production. Then prove repeated append generations, downstream
   compatibility, retention, and a periodic cold-audit policy. Do not relabel
