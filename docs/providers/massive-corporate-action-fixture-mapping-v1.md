...
exact-date Resolver passes the published Identity evidence binding. The first
real shadow preserved all 70,099 rows, resolving 42,056 and quarantining
28,043; it remains temporary and outcome-only.
